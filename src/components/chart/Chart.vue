...
firsttrade++;
        ...
        if (firsttrade == 2){
        firsttrade++;
        qty = -1*(margin222*((margin222*this.tickData.exchanges[trades[trades.length-1][0]].close)*200/2))
...
/*request(requestOptions, function(error, response, body) {
  ...
  console.log(body);
        ...
        firsttrade++;
        qty = (margin222*((margin222*this.tickData.exchanges[trades[trades.length-1][0]].close)*200/2))
if (thepair.indexOf('USD') == -1){
